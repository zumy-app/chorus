...
|---|---|---|---|---|---|---|
| 1 | `alice.dev@chorus.test` | `alice.dev` | `Alice Dev` | `en → es` | **Learner** — has 1 trial credit, 2 reviews for Sofia, used in `seedTutorMarketplace` | `ChorusDev2026!` |
| 2 | `bob.dev@chorus.test` | `bob.dev` | `Bob Dev` | `es → en` | **Learner** — second learner for booking/review flows | `ChorusDev2026!` |
...
# then in app:
# Login as alice.dev@chorus.test / ChorusDev2026!  → Learn hub shows dueToday>0 + 5 es scenarios
