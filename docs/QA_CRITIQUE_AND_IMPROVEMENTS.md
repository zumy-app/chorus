...
`alice.dev@chorus.test` / `bob.dev@chorus.test` / `sofia.tutor@chorus.test` password `ChorusDev2026!` (`dev_seed.go:17`), seeded via `global-setup.ts:103` `SeedDevData` + JWT clear.
