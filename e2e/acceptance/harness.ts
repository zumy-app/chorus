 ...
 *   learner (EN→ES): alice.en-es@chorus.test   password: ChorusDev2026!
 *   learner (ES→EN): bob.es-en@chorus.test     password: ChorusDev2026!
 *   tutor:   sofia.tutor@chorus.test password: ChorusDev2026!
...
export const DEV_PASSWORD = 'ChorusDev2026!'
