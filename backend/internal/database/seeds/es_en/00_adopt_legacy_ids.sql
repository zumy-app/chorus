-- 00_adopt_legacy_ids.sql: Legacy-content adoption (es->en).
...
DO $$
DECLARE
    canonical uuid := 'c0000000-0000-0000-0000-000000000002';
    legacy uuid;
BEGIN
    SELECT id INTO legacy FROM curriculum_courses
    WHERE native_language = 'es' AND target_language = 'en' AND version = 'v1'
      AND id <> canonical
    LIMIT 1;
    IF legacy IS NOT NULL THEN
        ...
        VALUES (canonical, 'es', 'en', 'English for Spanish Speakers', 'v1-adopt-tmp', 'full_course', true)
...
BEGIN
    FOR r IN
        ...
        JOIN (VALUES
            ('a1-introductions',              'a0000001-0000-0000-0000-000000000001'::uuid),
            ('a1-basics-ii',                  'a0000001-0000-0000-0000-000000000002'::uuid),
            ('a1-daily-routine',              'a0000001-0000-0000-0000-000000000003'::uuid),
            ('a1-ordering-food',              'a0000001-0000-0000-0000-000000000004'::uuid),
            ('a1-around-town',                'a0000001-0000-0000-0000-000000000005'::uuid),
            ('a1-checkpoint',                 'a0000001-0000-0000-0000-000000000006'::uuid),
            ('a2-past-weekend',               'a0000001-0000-0000-0000-000000000007'::uuid),
            ('a2-shopping',                   'a0000001-0000-0000-0000-000000000008'::uuid),
            ('a2-plans',                      'a0000001-0000-0000-0000-000000000009'::uuid),
            ('a2-health-feelings',            'a0000001-0000-0000-0000-000000000010'::uuid),
            ('a2-travel-basics',              'a0000001-0000-0000-0000-000000000011'::uuid),
            ('a2-checkpoint',                 'a0000001-0000-0000-0000-000000000012'::uuid),
            ('b1-stories',                    'a0000001-0000-0000-0000-000000000013'::uuid),
            ('b1-opinions',                   'a0000001-0000-0000-0000-000000000014'::uuid),
            ('b1-problems',                   'a0000001-0000-0000-0000-000000000015'::uuid),
            ('b1-social-plans',               'a0000001-0000-0000-0000-000000000016'::uuid),
            ('b1-work-study',                 'a0000001-0000-0000-0000-000000000017'::uuid),
            ('b1-checkpoint',                 'a0000001-0000-0000-0000-000000000018'::uuid),
            ('b2-nuanced-opinions',           'a0000001-0000-0000-0000-000000000019'::uuid),
            ('b2-hypotheticals',              'a0000001-0000-0000-0000-000000000020'::uuid),
            ('b2-professional-communication', 'a0000001-0000-0000-0000-000000000021'::uuid),
            ('b2-media-culture',              'a0000001-0000-0000-0000-000000000022'::uuid),
            ('b2-conflict-repair',            'a0000001-0000-0000-0000-000000000023'::uuid),
            ('b2-checkpoint',                 'a0000001-0000-0000-0000-000000000024'::uuid)
...
BEGIN
    FOR r IN
        ...
        JOIN (VALUES
            ('to-be-subject-pronouns',          'b0000001-0000-0000-0000-000000000001'::uuid),
            ('questions-with-do',               'b0000001-0000-0000-0000-000000000002'::uuid),
            ('present-simple-third-person',     'b0000001-0000-0000-0000-000000000003'::uuid),
            ('would-like-articles',             'b0000001-0000-0000-0000-000000000004'::uuid),
            ('there-is-prepositions',           'b0000001-0000-0000-0000-000000000005'::uuid),
            ('past-simple-regular-irregular',   'b0000001-0000-0000-0000-000000000006'::uuid),
            ('going-to-have-to',                'b0000001-0000-0000-0000-000000000007'::uuid),
            ('past-simple-vs-past-continuous',  'b0000001-0000-0000-0000-000000000008'::uuid),
            ('conditionals-second',             'b0000001-0000-0000-0000-000000000009'::uuid),
            ('reported-speech-passive',         'b0000001-0000-0000-0000-000000000010'::uuid)
        ) AS m(slug, canonical_id) ON m.slug = gp.slug
        WHERE gp.course_id = 'c0000000-0000-0000-0000-000000000002'
...
BEGIN
    FOR r IN
        ...
        JOIN (VALUES
            ('ordering-coffee', 'd0000001-0000-0000-0000-000000000001'::uuid),
            ('hotel-checkin',   'd0000001-0000-0000-0000-000000000002'::uuid)
        ) AS m(slug, canonical_id) ON m.slug = ss.slug
        WHERE ss.course_id = 'c0000000-0000-0000-0000-000000000002'
